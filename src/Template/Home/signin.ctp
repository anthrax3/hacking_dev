			        ...
			        <div class="row" style="margin-top:10%;">
			          <div class="card z-depth-5">
				            ...
				            <div class="hoverable card-content mg-padding-0" style="border-top:3.5px solid #292929;">
				                <h6 class="mg-size-30 mg-padding-10 mg_sec_background_2 white-text mg-margin-0">Inscription</h6>
				                <div class="row center mg-padding-top-20 mg-padding-bottom-20 mg-margin-0" >
				                   <div class="container" >
						                <form name="loginForm" ng-submit="signinctrl.signin(user)" ng-hide="signinctrl.loader">
											...
											<div class="col s12 mg-padding-top-10 mg-padding-bottom-10">
											    	<button ng-disabled="loginForm.$invalid" class="btn btn-default mg-button-2" style="width: 100%;">Inscription</button>
											</div>

						                </form>
						                
					                  <div class="progress mg_sec_background_1" ng-show="signinctrl.loader">
				            ...
				            <div class="card-action transparent mg-padding-0 none-border">
				              <a href="#" class="white-text mg-size-14 btn mg-width-100-perc mg_sec_background_1" ui-sref="app.home">>> Connexion</a>
				            </div>
			          </div>
			        </div>
		  </div>
